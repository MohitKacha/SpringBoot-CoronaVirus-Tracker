package com.springboot.coronavirus.tracker.services;

import com.springboot.coronavirus.tracker.model.LocationStats;
...
public class CoronaVirusDataService {
    ...
    public void fetchData() throws IOException, InterruptedException {
        ...
        StringReader csvReader = new StringReader(response.body().toString());
        ...
        for (CSVRecord record : records) {
            ...
            newStats.add(new LocationStats(state,country,lastDayCases,
                                    Math.abs(lastDayCases - previousDayCases)));
        }
        locationStatsList = newStats;
    }
